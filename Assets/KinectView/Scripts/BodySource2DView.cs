...
public class BodySource2DView : MonoBehaviour 
{
    ...
    {
		var colorPoint = _BodyManager.Sensor.CoordinateMapper.MapCameraPointToColorSpace(joint.Position);
		return new Vector3(colorPoint.X * scale / 1920, -colorPoint.Y * scale / 1080, 0);
