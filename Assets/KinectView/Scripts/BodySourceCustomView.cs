...
public class BodySourceCustomView : MonoBehaviour 
{
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            ...
            {
                leftHandItem.transform.position = Vector3.zero;
                leftHandItem.transform.parent = jointObj.transform;
            }

            if (jt == Kinect.JointType.HandRight)
            {
                rightHandItem.transform.position = Vector3.zero;
                rightHandItem.transform.parent = jointObj.transform;
            }
